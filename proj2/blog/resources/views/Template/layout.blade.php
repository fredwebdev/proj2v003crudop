        ...
        <nav class="light-green darken-4" role="navigation">
            <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                    <li class="light-green darken-3"><a href="#modal0" class="modal-trigger white-text"><img src="{{URL::asset('media/icons/fa-power.png')}}" style="margin-right: 10px">CONNEXION</a></li>
